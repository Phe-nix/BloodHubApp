...
const SmallNewsBox: React.FC<any> = ({ item, fetch, navigation }) => {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.rightContainer}>
            <View style={styles.textRight}>
              <Text style={styles.name}>{news.title.slice(0,40) + "..."}</Text>
              ...
              <Image style={{width: 18, height:20, position: 'absolute', top: 0, right: 10}} source={news.isBookmark ? require('../../../assets/icon/icon_bookmarked.png') : require('../../../assets/icon/icon_bookmark.png')} />
              </TouchableOpacity>
            </View>
